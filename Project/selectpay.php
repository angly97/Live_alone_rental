...
<body>
  <div class="login_page">
    <div class="loginscreen">
      <form="select_form">
      <h1 align=center >결제 방법 선택</h1>
      <button class="selectcard" onclick="location.href='http://localhost/Project/cardpay.php'">카드 결제</button>
      <!-- <meta http-equiv='refresh' content='0;url=http://127.0.0.1/cardpay.php'> -->
      <button class="selectdeposit" onclick="location.href='http://localhost/Project/depositpay.php'">무통장 입금</button>
    </form>
    </div>
  </div>
</body>
